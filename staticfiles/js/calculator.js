...
function calculatorinitialiser(){
    ...
    if(debugcalculator){
        for (var target of listoftargetobjects){
            console.log(target);
        }
        checkforinputs();
    }
    for (var element of activatehidden){
        calculate(element);
    }
...
function checkforinputs(){
    ...
    for (var target of listoftargetobjects){
        ...
        for (var innertarget of listoftargetobjects){
